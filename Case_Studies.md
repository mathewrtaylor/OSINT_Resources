...
- **[Bellingcat_Solve](https://github.com/Moontasir1091/Bellingcat_Solve)** - This repository contains my solutions, research notes, and methodologies for solving Bellingcat OSINT challenges. It includes image analysis, reverse image search, geolocation, metadata investigation, map verification, and other open-source intelligence techniques.
  - Created by [Moontasir1091](https://github.com/Moontasir1091) on 2026-07-24
  - Last updated on 2026-07-24. (Stars: 0)
...
- **[Islamic-Republic-Influence-Networks](https://github.com/goldenowlosint/Islamic-Republic-Influence-Networks)** - 📊 OSINT dataset of 10,700+ Twitter/X accounts linked to Islamic Republic influence networks. Metadata-only for CIB research & network analysis.
  ...
  - Last updated on 2026-07-20. (Stars: 77)
...
- **[OSINT-Industries-Writeups](https://github.com/Yangtoinette/OSINT-Industries-Writeups)** - Résumés (writeups) pour les challenges du site OSINT Industries.
  - Created by [Yangtoinette](https://github.com/Yangtoinette) on 2026-06-28
  - Last updated on 2026-07-14. (Stars: 0)
...
- **[OSINTOPIA-Writeups](https://github.com/Yangtoinette/OSINTOPIA-Writeups)** - Résumés (writeups) pour les challenges du site OSINTOPIA. 
  - Created by [Yangtoinette](https://github.com/Yangtoinette) on 2026-07-07
  - Last updated on 2026-07-14. (Stars: 0)
- **[THREAT-INTELLIGENCE-ANALYSIS-USING-OPEN-SOURCE-INTELLIGENCE-AND-VIRUSTOTAL](https://github.com/BashiruDamoah/THREAT-INTELLIGENCE-ANALYSIS-USING-OPEN-SOURCE-INTELLIGENCE-AND-VIRUSTOTAL)** - Practical cyber threat intelligence investigation of a suspicious domain using OSINT techniques and VirusTotal.
  - Created by [BashiruDamoah](https://github.com/BashiruDamoah) on 2026-06-10
  - Last updated on 2026-06-10. (Stars: 0)
...
- **[screenconnect-rogue-tenant-investigation](https://github.com/yankywilson/screenconnect-rogue-tenant-investigation)** - threat-intelligence  cti  malware-analysis  screenconnect   phishing  ioc  detection-rules  suricata  sigma   incident-response  osint  rmm-abuse
